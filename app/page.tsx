  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 py-8 sm:py-12 min-h-[calc(100vh-64px)]">
      <div className="max-w-4xl w-full text-center">
        ...
        <p className="text-base sm:text-xl text-gray-100 mb-8 sm:mb-12 px-2">
          大人のためのオンラインボードゲームプラットフォーム
        </p>
        <Link
          href="/games"
          className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg transition-colors duration-200"
        >
          ゲームを始める
        </Link>
        <div className="mt-12 sm:mt-16 text-gray-200 text-sm px-2">
